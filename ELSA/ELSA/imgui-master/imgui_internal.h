...
namespace ImGui
{
	...
	//Erik leker
	IMGUI_API void          PlotEx(ImGuiPlotType plot_type, const char* label, std::vector<float>* values, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 graph_size);
	// Plot
