	...
	if (_loadResultWindow && !simulate())
	{
		...
		if (ImGui::Button("Load")) 
		{
			...
			else 
			{
				...
				printf("Size of file: %f", sizeOfFile);
				if (_temp.size() == 0)
				{
					_temp.resize(sizeOfFile);
				}
				if (_totalEnergy.size() == 0)
				{
...
if (_plotVisible)
	{
		...
		{
			float* cohEnEnD = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* debyeTempEnD = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* pressureEnD = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* kinEnD = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* msdEnD = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* potEnD = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* selfDiffEnD = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* specHeatEnD = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* temp = new float[numberOfTimeSteps];
			float max = -1E15;
			float min = 1E15;
			float sumLast10 = 0;
		...
		{
			float* totEn = new float[numberOfTimeSteps];
			float max = -1E5;
			float min = 1E5;
			float sumLast10 = 0;
